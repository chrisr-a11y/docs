...
| `last_px` | `int` | **Price of this fill** (÷ 1000) |
...
class PolymarketOrderStreamer:
    ...
    def _display_execution(self, execution):
        ...
        if execution.last_px > 0:
            last_px = execution.last_px / 1000
