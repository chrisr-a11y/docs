...
The Polymarket Exchange API uses **JWT (JSON Web Token)** authentication. Tokens are obtained through Auth0.
...
sequenceDiagram
    ...
    REST API->>Client: Access Token + Expiration
...
Authenticate with Auth0 to obtain an initial JWT token.

## Step 2: Exchange for Access Token

Exchange your Auth0 token for an API access token via the REST API.
