...
|-------------|-------------|
| **Development** | `auth.dev.polymarketexchange.com` |
| **Pre-production** | `auth.preprod.polymarketexchange.com` |
...
<CardGroup cols={2}>
  <Card title="Authentication Setup" icon="key" href="/getting-started/authentication">
