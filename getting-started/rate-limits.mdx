...
| Streaming ingress (client → server) | 20 messages/sec |
...
<Warning>
Abuse of the API may result in temporary or permanent restrictions on your API credentials. Contact [fixapi@polymarket.com](mailto:fixapi@polymarket.com) if you need higher limits for legitimate use cases.
</Warning>
