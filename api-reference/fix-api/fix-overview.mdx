...
Static IP addresses of FIX engines must be white-listed in Polymarket US. Contact [support@qcex.com](mailto:support@qcex.com) to request this and Sender/TargetCompID.
