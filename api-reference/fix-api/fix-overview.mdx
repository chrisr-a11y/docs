...
The purpose of this document is to outline the trading functionality available via a FIX trading protocol.  For the Drop-Copy FIX specification, please contact [fix@qcex.com](mailto:fix@qcex.com)

## Platform Connectivity & Overview

Static IP addresses of FIX engines must be allowlisted by Polymarket US. Contact [fix@qcex.com](mailto:fix@qcex.com) to request this and Sender/TargetCompID.
