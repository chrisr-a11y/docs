...
The purpose of this document is to outline the trading functionality available via a FIX trading protocol.  For the Drop-Copy FIX specification, please contact [fixapi@polymarket.com](mailto:fixapi@polymarket.com)

## Platform Connectivity & Overview

Static IP addresses of FIX engines must be white-listed in Polymarket US. Contact [fixapi@polymarket.com](mailto:fixapi@polymarket.com) to request this and Sender/TargetCompID.
