...
Static IP addresses of FIX engines must be allowlisted by Polymarket US. Contact [fixapi@polymarket.com](mailto:fixapi@polymarket.com) to request this and Sender/TargetCompID.
