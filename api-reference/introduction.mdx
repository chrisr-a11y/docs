...
<Card title="ISV Partner Guide" icon="building" href="/isv-partners/overview">
  Complete guide for ISV partners including Accounts, KYC, and Payments APIs
</Card>
...
- **ISV partners (retail platforms)**: Use Trading APIs plus the [ISV Partner Guide](/isv-partners/overview) APIs
</Info>
