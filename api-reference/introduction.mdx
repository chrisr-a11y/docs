...
| KYC and payments | REST ISV Partner APIs |
...
For partners building retail trading platforms. These APIs manage end-users and their accounts.

| Endpoint Group | Description |
|----------------|-------------|
| **Accounts** | User and account management |
| **KYC** | Identity verification workflow |
| **Payments** | Aeropay (ACH) and Checkout.com (card) funding |

<Card title="ISV Partner Guide" icon="building" href="/isv-partners/overview">
  Complete guide for ISV partners including user lifecycle, KYC, and payments integration
</Card>

<Info>
**Which APIs do I need?**

- **Direct trading partners**: Use Trading APIs only
- **ISV partners (retail platforms)**: Use both Trading APIs and ISV Partner APIs - see the [ISV Partner Guide](/isv-partners/overview)
</Info>
