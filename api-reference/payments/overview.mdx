...
<Warning>
**Authentication Required** - All payment endpoints require a valid Auth0 JWT token. See [Auth0 Onboarding](/getting-started/auth0-onboarding) for setup instructions.
</Warning>
