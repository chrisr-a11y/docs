...
<Warning>
**Auth0 JWT Required** - All Checkout endpoints require authentication. Include your Auth0 JWT token in the `Authorization` header.
</Warning>
...
See [Auth0 Onboarding](/getting-started/auth0-onboarding) for instructions on obtaining tokens.
