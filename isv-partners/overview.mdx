...
Before you can access the API, complete these onboarding steps:
...
<Steps>
  <Step title="Generate your API keys">
    ...
    ```
    <Warning>
    **Keep your private key secret!** Store it securely with `chmod 600 my_private_key.pem`. Never share it with anyone.
    </Warning>
  </Step>
  <Step title="Share your public key">
    Create a Google Doc, paste the contents of `my_public_key.pem`, and share it with **fixapi@polymarket.com**
  </Step>
  <Step title="Receive your credentials">
    We'll provide your Client ID and environment details
  </Step>
</Steps>

<Card title="Full Authentication Setup" icon="key" href="/getting-started/authentication">
  Complete guide with code examples for Python, Go, and cURL
</Card>
