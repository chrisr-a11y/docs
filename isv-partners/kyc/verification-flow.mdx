...
3. Makes the user ready for funding and trading

There is no separate account creation step required. The user can proceed directly to [funding](/isv-partners/payments/overview) after KYC approval.
</Info>
