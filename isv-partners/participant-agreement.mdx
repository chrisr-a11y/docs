...
1. **Download the ZIP file** above (contains all onboarding Word documents), fill out `participant-agreement.docx`, and upload it to the shared Google Drive folder
