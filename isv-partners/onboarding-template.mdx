...
Copy this template into a Google Document named **"{Company Name} Onboarding Document"** and save as PDF for your onboarding folder.
...
- Corporate Application (`{companyname} Corporate Application`) - *if applying as a corporate entity*

Contact Polymarket to obtain these forms.
</Info>
