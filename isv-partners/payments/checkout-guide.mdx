...
<Tip>
**Display `userMessage` to Users**

The `userMessage` field contains a user-friendly explanation of the error. Display this to your users instead of the raw `errorCodes`. The `errorCodes` array is for programmatic error handling and logging.
</Tip>
