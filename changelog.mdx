...
mode: "center"
---
<Update label="December 21, 2025" description="v0.0.14">
 - Added REST and gRPC health check examples to landing page
 - Added gRPC health check documentation with environment endpoints
 - Improved navigation: Health Check moved earlier in Getting Started
 - Updated authentication diagram for clarity
 - Standardized REST URL format across documentation
</Update>
